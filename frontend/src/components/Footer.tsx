            ...
            <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
                    <div className="lg:col-span-2">
                        ...
                        <p className="mt-4 max-w-md text-sm text-gray-600">
                            Streamline your team's workflow with our collaborative platform.
                            Connect, create, and collaborate seamlessly across distances.
                        </p>
                ...
                <div className="mt-12 border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-sm text-gray-500">
                        &copy; {currentYear} RemoteCollab Inc. All rights reserved.
                    </p>
